...
function fn_comment(code){
    $.ajax({
        type:'GET',
        url : '${pageContext.request.contextPath}/addComment?themecode=${festatodetailpage.themecode}&themepostid=${festatodetailpage.contentid}&userid=${sessionScope.account.userid}',
...
function getCommentList(){
    ...
    $.ajax({
        type:'GET',
        url : "<c:url value='commentList?themecode=${festatodetailpage.themecode}&themepostid=${festatodetailpage.contentid}'/>",
        dataType : "json",
        data:$("#commentForm").serialize(),
