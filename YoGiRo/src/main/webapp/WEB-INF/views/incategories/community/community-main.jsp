		...
		<div class="table-con">
			...
			<div class="pagenum">
				...
				<c:choose>
					...
					<c:otherwise>
						<a href="${pageContext.request.contextPath}/com/main?num=${minBlock-1}${query}">
							<i class="fas fa-angle-left"></i>
							<i class="fas fa-angle-left pagingarrow-left2"></i>
						</a>
					</c:otherwise>
				...
				<c:choose>
					...
					<c:otherwise>
						<a href="${pageContext.request.contextPath}/com/main?num=${num-1}${query}">
							<i class="fas fa-angle-left pagingarrow-left"></i>
						</a>
					</c:otherwise>
				</c:choose>
				<c:forEach begin="${minBlock}" end="${maxBlock>total?total:maxBlock}" step="1" var="i">
					<c:choose>
						<c:when test="${num == i}">
							<b>${i}</b>
						</c:when>
						<c:otherwise>
							<a href="${pageContext.request.contextPath}/com/main?num=${i}${query}">${i}</a>
						</c:otherwise>
					</c:choose>
				</c:forEach>
				<c:choose>
				...
				<c:choose>
					<c:when test="${maxBlock > total}">
						<span>
							<i class="fas fa-angle-right pagingarrow-right2"></i>
							<i class="fas fa-angle-right"></i>
						</span>
					</c:when>
					<c:otherwise>
						<a href="${pageContext.request.contextPath}/com/main?num=${maxBlock+1}${query}">
