...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/login/css/login.css">
</head>
<body class="body vh">
	<div class="container vh">
		...
		<main class="login_main">
			<div id="login">
				<div id="login_box">
					<form class="login_content animate"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/resources/login/js/login.js"></script>
</body>
</html>